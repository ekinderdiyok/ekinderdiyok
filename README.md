...
| Segmenting customers of an online fashion retailer and gathering actionable insights | Generated synthetic data, built a database, run queries, segmented customers using k-means and Recency-Frequency-Monetary (RFM). | **Python**, **SQL**, Jupyter | [GitHub](https://github.com/ekinderdiyok/customer-segmentation)
